...
const AboutPage = ({ data }) => { return (
  ...
  <ContentColumn>
      ...
      <p className="text-2xl xs:text-xl leading-snug text-gray-500 pb-4 text-justify xs:text-left">I am a Product Manager with a dynamic background as developer and marketer, with 6+ years of experience working with web technologies. I'm passion about delivering outstanding experiences and to build meaningful collaborations that allow teams to create extraordiary work. </p>
      <img src="/image 9.jpg" alt="Paulo Teixeira - Product Manager" className="flex pb-4 max-w-md xs:max-w-full mx-auto" />
