...
const AboutPage = ({ data }) => { return (
  ...
  <ContentColumn>
      ...
      <Img fluid={data.file.childImageSharp.fluid} alt="Paulo Teixeira - Product Manager" className="h-full w-full object-cover mx-24 xs:mx-4 mb-4" css={{boxShadow: `10px 10px 0px 0px #F8B500;`}} />
