        ...
        <li className="mt-10 md:mt-0">
          <div className="flex">
            ...
            <div className="ml-4">
              ...
              <p className="mt-2 text-base leading-6 text-gray-500">
              {/* Every problem requires a personalized solution.*/}
               I challenge those around me to get to the root cause and to be resourceful. Building a complex solution it's easy, but making it simple, it's harder. 
              </p>
            </div>
          </div>
        </li>
        <li className="mt-10 md:mt-0">
          <div className="flex">
            ...
            <div className="ml-4">
              ...
              <p className="mt-2 text-base leading-6 text-gray-500">
                Launching features is great, but what matters is the impact generated by what we do on the users, customers, and business. There is where the focus should be.
              </p>
            </div>
          </div>
        </li>
