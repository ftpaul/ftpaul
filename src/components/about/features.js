      ...
      <ul className="md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
        <li>
          <div className="flex">
            ...
            <div className="ml-4">
              <h4 className="text-lg leading-6 font-medium text-gray-900">Product</h4>
              <p className="mt-2 text-base leading-6 text-gray-500">
              From defining MVPs to launch them in the market. I am an experienced product person that looks to focus on building the right thing.
              </p>
            </div>
          </div>
        </li>
        <li className="mt-10 md:mt-0">
          <div className="flex">
            ...
            <div className="ml-4">
              <h4 className="text-lg leading-6 font-medium text-gray-900">Growth</h4>
              <p className="mt-2 text-base leading-6 text-gray-500">
              Focusing on the intersection between Product and Marketing, I impact the company's growth by creating and optimizing experiences that drive value.
              </p>
            </div>
          </div>
        </li>
        <li className="mt-10 md:mt-0">
          <div className="flex">
            ...
            <div className="ml-4">
              <h4 className="text-lg leading-6 font-medium text-gray-900">Management</h4>
              <p className="mt-2 text-base leading-6 text-gray-500">
              Throughout my career, I've empowered individuals and teams to be at their best. People are key in any strategy, and I aim to build an environment where they can prosper.
              </p>
            </div>
          </div>
        </li>
        <li className="mt-10 md:mt-0">
          <div className="flex">
            ...
            <div className="ml-4">
              <h4 className="text-lg leading-6 font-medium text-gray-900">Methodologies</h4>
              <p className="mt-2 text-base leading-6 text-gray-500">
              I love to build and iterate methodologies that help us thrive in chaotic environments and situations. Everything can be seen as a learning opportunity and I try to maximize them.
              </p>
            </div>
          </div>
        </li>
