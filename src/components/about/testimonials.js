...
export default () => (
  ...
  <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="lg:text-center">
      ...
      There are no better references than the people that work with me in the past, you can see some below and I am happy to provide more upon request.
      </p>
    </div>
    ...
    <div class="flex flex-wrap my-8">
          ...
          <div class="w-1/2 lg:w-1/2 sm:w-1/2 xs:w-full mx-auto pt-1 text-left pr-4 border-r-2 border-yellow-600 xs:border-r-0 xs:border-b-2 xs:pb-8">
              <svg xmlns="http://www.w3.org/2000/svg" className="absolute -ml-4 -mt-4 fill-current text-yellow-600 h-12 w-12 z-0" viewBox="0 0 24 24"><path d="M13 14.725c0-5.141 3.892-10.519 10-11.725l.984 2.126c-2.215.835-4.163 3.742-4.38 5.746 2.491.392 4.396 2.547 4.396 5.149 0 3.182-2.584 4.979-5.199 4.979-3.015 0-5.801-2.305-5.801-6.275zm-13 0c0-5.141 3.892-10.519 10-11.725l.984 2.126c-2.215.835-4.163 3.742-4.38 5.746 2.491.392 4.396 2.547 4.396 5.149 0 3.182-2.584 4.979-5.199 4.979-3.015 0-5.801-2.305-5.801-6.275z"/></svg>
          ...
          <div class="w-1/2 lg:w-1/2 sm:w-1/2 xs:w-full mx-auto pt-1 pl-8 text-left xs:pl-0 xs:pt-8">
              ...
              <p class="mt-2 text-xl leading-6 italic text-gray-400 z-10 relative">Paulo adapts very fast to the changing conditions of the market, which often require last minute changes to on-going projects. These are never a problem but are seen as an opportunity to further improve our position.</p>
              <div className="text-base leading-6 font-medium text-gray-500 mt-4 text-left ml-2 xs:ml-0 flex ">
