...
const ExperienceBlock = ({ job }) => (
    <>
      <div className="py-1">
        ...
        <p className="text-base pt-1 xs:pl-12 inline-block xs:block  xs:-mt-16 xs:pt-4 xs:font-sm">
          ...
          <span className="text-sm text-gray-300 ">{job.start_date} - {job.end_date}</span>
