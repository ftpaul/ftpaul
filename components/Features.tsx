    ...
    <div className="max-w-screen-xl mx-auto sm:px-6">
        ...
        <ul className="md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
            ...
            <div className="flex">
                ...
                Thinking about the long term and defining the strategy are the core of how I act. I make the connection between what we do daily with the long-term vision.
                </p>
                </div>
            </div>
            </li>
            ...
            <div className="flex">
                ...
                <p className="mt-2 text-base leading-6 text-gray-500">
                I love building and iterating methodologies that help people thrive in chaotic environments and situations. Growing implies constant change, and it's crucial to adapt.
                </p>
                </div>
            </div>
            </li>
            ...
            <div className="flex">
                ...
                <p className="mt-2 text-base leading-6 text-gray-500">
                I challenge myself and those around me to get to the root cause and to be resourceful. Coming up with a complex solution is effortless, but making it simple it's where the challenge is. 
                </p>
                </div>
            </div>
            </li>
            ...
            <div className="flex">
                ...
                <p className="mt-2 text-base leading-6 text-gray-500">
                Launching a feature is great, but what matters is the impact generated by what we build. There is where the focus should be.
                </p>
                </div>
            </div>
            </li>
